...
function wpCalendar(){
	...
	this.themename	= "xc";						//主题设置，决定日历的外观
...
var theme=new Object();
  ...
  theme["xc"]=new CalendarTheme();
	theme["xc"].versioninfo			= "主题：NewAge 作者：WalkingPoison";	//主题的版本信息
	theme["xc"].fontFamily			= "宋体";		//字体
	theme["xc"].borderColor			= "#336699";	//边框颜色
	theme["xc"].borderColorDark		= "#FFFFFF";	//边框暗部颜色
	theme["xc"].bgColorMain			= "#336699";	//日历主背景色
	theme["xc"].bgColorLight		= "#F0F8FF";	//日历的浅背景色
	theme["xc"].headBgColor			= "#FFFFFF";	//日历头部背景色
	theme["xc"].headFontColor		= "#000000";	//日历头部字体颜色
	theme["xc"].mouseOverColor		= "#add8e6";	//鼠标移动的背景色
	theme["xc"].mouseOverFontColor	= "#000000";	//鼠标移动的字体颜色
	theme["xc"].buttonBorderColor	= "#336699";	//按钮边框颜色
	theme["xc"].buttonColor			= "#F0F8FF";	//按钮的主色调
	theme["xc"].buttonFontColor		= "#000000";	//按钮文字颜色
	theme["xc"].dragBarFontColor	= "#FFFFFF";	//拖动条的文字颜色
	theme["xc"].dragBarColor		= "#336699";	//拖动条的边框颜色
	theme["xc"].dragBarColorDark	= "#336699";	//拖动条的边框暗部颜色
	theme["xc"].normalDayColor		= "#ffffff";	//日期的背景颜色
	theme["xc"].normalDayFontColor	= "#000000";	//日期的字体颜色
	theme["xc"].grayDayColor		= "#f5f5f5";	//非本月日期的背景颜色
	theme["xc"].grayDayFontColor	= "#808080";	//非本月日期的字体颜色
	theme["xc"].todayColor			= "#add8e6";	//当前日期的背景颜色
	theme["xc"].todayFontColor		= "#000000";	//当前日期的字体颜色
	theme["xc"].selectedDayColor	= "#336699";	//选中日期的背景颜色
	theme["xc"].selectedDayFontColor= "#FFFFFF";	//选中日期的字体颜色
