...
public class Telz extends Activity {
...
//		mylist.setAdapter(arrayA);
		OnItemClickListener listener = new OnItemClickListener() {
			...
			//	标题的选择显示 打电话教学院系行政机构
				Intent it = new Intent(Telz.this, Telinfo.class); 
		...
		imagebtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
		        ...
		        intent.setClass(Telz.this, Telsearch.class);
	...
	private class InfoAdapter extends ArrayAdapter<String> {
        public InfoAdapter(String[] mlistArray) {
            super(Telz.this, R.layout.around_tel, mlistArray);
        }
        @Override
	...
	private String query(){
		// 查询参数
		String queryString = "departmentCode=002";
