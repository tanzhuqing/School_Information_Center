...
public class Tely extends Activity {
...
//		mylist.setAdapter(arrayA);
		OnItemClickListener listener = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v,
			    ...
			    //标题的选择显示 打电话教学院系行政机构
				Intent it = new Intent(Tely.this, Telinfo.class); 
		...
		imagebtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
		        ...
		        intent.setClass(Tely.this, Telsearch.class);
	 ...
	 private class InfoAdapter extends ArrayAdapter<String> {
	        ...
	        public InfoAdapter(String[] mlistArray) {
	            super(Tely.this, R.layout.around_tel, mlistArray);
	        }
	...
	private String query(){
		// 查询参数
		String queryString = "departmentCode=003";
